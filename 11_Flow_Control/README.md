...
# LOG File Archive Dir
LOG_LOG_FILE_ARCHIVE_PATH="/opt/archive"

# Check if the file exists
if [ -f "$LOG_FILE_PATH" ]; then
    echo "Log file exists. Archiving statrted"
    mkdir -p "$LOG_FILE_ARCHIVE_PATH"
    mv "$LOG_FILE_PATH" "$LOG_FILE_ARCHIVE_PATH/$(date + '%Y-%m-%d_%H-%M-%S')_access.log"
